          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-900 font-semibold" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span className="uppercase text-sm font-medium text-blue-900 font-semibold">Phone</span>
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="uppercase text-sm  text-blue-900 font-semibold">Email</span>
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="uppercase text-sm text-blue-900 font-semibold">Address</span>
              </div>
              <p>Lucknow, India</p>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="uppercase text-sm text-blue-900 font-semibold">Opening Hours</span>
              </div>
